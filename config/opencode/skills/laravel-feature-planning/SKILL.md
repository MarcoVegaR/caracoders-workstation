# Laravel Feature Planning

## Purpose

Turn a PRD or requirement into a safe Laravel implementation plan.

## When to use

- Planning routes, migrations, models, policies, jobs, events, tests and UI integration.
